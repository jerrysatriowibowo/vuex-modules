                ...
                <div class="flex-auto p-6">
                    <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                        <a href="#"
                            ...
                            <span
                                class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">Login Form</span>
                        </a>
                    </div>
                    <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Login Form Terserah Gw!</h4>
                    <p class="mb-6 text-gray-500">Mohon Login Terlebih Dulu Untuk Masuk!</p>
                        ...
                        <div class="mb-4">
                            <div class="block">
                                <input
                                    ...
                                    checked />
                                <label class="inline-block" for="remember-me"> Saya Menyetujui Persyaratan Yang Ada </label>
                            </div>
                        </div>
                        <div class="mb-4">
                            <button
